...
var FileEntity = function () {
    var _classDecorators = [(0, typeorm_1.Entity)({ name: 'file' })];
    ...
    var FileEntity = _classThis = /** @class */ (function (_super) {
        __extends(FileEntity_1, _super);
        function FileEntity_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.id = __runInitializers(_this, _id_initializers, void 0);
            _this.path = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _path_initializers, void 0));
            __runInitializers(_this, _path_extraInitializers);
            return _this;
        }
        return FileEntity_1;
    }(_classSuper));
    __setFunctionName(_classThis, "FileEntity");
    (function () {
        var _a;
        ...
        FileEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FileEntity = _classThis;
}();
