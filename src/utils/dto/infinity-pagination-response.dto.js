...
var InfinityPaginationResponseDto = /** @class */ (function () {
    function InfinityPaginationResponseDto() {
    }
    return InfinityPaginationResponseDto;
}());
...
function InfinityPaginationResponse(classReference) {
    var Pagination = function () {
        ...
        return _a = /** @class */ (function () {
                function Pagination() {
                    ...
                    this.hasNextPage = (__runInitializers(this, _data_extraInitializers), __runInitializers(this, _hasNextPage_initializers, void 0));
                    __runInitializers(this, _hasNextPage_extraInitializers);
                }
                return Pagination;
            }()),
            (function () {
                var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
                _data_decorators = [(0, swagger_1.ApiProperty)({ type: [classReference] })];
    ...
    Object.defineProperty(Pagination, 'name', {
        writable: false,
        value: "InfinityPagination".concat(classReference.name, "ResponseDto"),
    });
    return Pagination;
}
