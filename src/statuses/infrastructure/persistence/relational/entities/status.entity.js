...
var StatusEntity = function () {
    ...
    var StatusEntity = _classThis = /** @class */ (function (_super) {
        __extends(StatusEntity_1, _super);
        function StatusEntity_1() {
        ...
        return StatusEntity_1;
    }(_classSuper));
    __setFunctionName(_classThis, "StatusEntity");
    (function () {
        var _a;
        ...
        StatusEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StatusEntity = _classThis;
}();
