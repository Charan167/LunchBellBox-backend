...
var RolesGuard = function () {
    ...
    var RolesGuard = _classThis = /** @class */ (function () {
        ...
        RolesGuard_1.prototype.canActivate = function (context) {
            var _a, _b;
            var roles = this.reflector.getAllAndOverride('roles', [context.getClass(), context.getHandler()]);
            if (!roles.length) {
                return true;
            }
            var request = context.switchToHttp().getRequest();
            return roles.map(String).includes(String((_b = (_a = request.user) === null || _a === void 0 ? void 0 : _a.role) === null || _b === void 0 ? void 0 : _b.id));
        };
        return RolesGuard_1;
    }());
