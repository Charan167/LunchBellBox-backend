...
var RoleEntity = function () {
    ...
    var RoleEntity = _classThis = /** @class */ (function (_super) {
        __extends(RoleEntity_1, _super);
        function RoleEntity_1() {
    ...
    __setFunctionName(_classThis, "RoleEntity");
    (function () {
        var _a;
        ...
        RoleEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RoleEntity = _classThis;
}();
