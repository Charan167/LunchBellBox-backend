...
var session_repository_2 = require("./repositories/session.repository");
var typeorm_1 = require("@nestjs/typeorm");
var session_entity_1 = require("./entities/session.entity");
var RelationalSessionPersistenceModule = function () {
    ...
    var _classThis;
    var RelationalSessionPersistenceModule = _classThis = /** @class */ (function () {
        function RelationalSessionPersistenceModule_1() {
        }
        return RelationalSessionPersistenceModule_1;
    }());
    __setFunctionName(_classThis, "RelationalSessionPersistenceModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        RelationalSessionPersistenceModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RelationalSessionPersistenceModule = _classThis;
}();
